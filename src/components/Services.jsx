    ...
    <section className='py-20 px-4 md:px-6 bg-[#0D0D0D]'>
        ...
        className='max-w-6xl mx-auto text-center mb-16'>
            <h2 className='text-2xl md:text-3xl mb-1'>
                <span className='bg-linear-to-r from-white via-gray-300 to-gray-500 text-transparent bg-clip-text'>Collaborate with brands </span>
                <span className='text-gray-500 md:text-[28px]'>and agencies to </span>
               
            </h2>
            <p> <span className='md:text-[27px] bg-linear-to-r from-gray-200 via-gray-400 to-gray-500 text-transparent bg-clip-text'>create impactful results.</span></p>
        </motion.div>
