  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-[70vh] text-center'>
        ...
        <div className='relative'>
            <div className='relative mb-8'>
                ...
                className='absolute -rotate-3 top-0 -right-28 z-30 bg-white text-black px-4 py-2 rounded-full shadow-lg'>
                    <p className='text-sm font-medium'>Md Rony Rahman 👋🏼 </p>
                </motion.div>
            </div>
        </div>
        ...
        className='md:text-5xl text-3xl px-2 md:px-0 font-medium mb-4 max-w-xl'>
           <span className='bg-linear-to-r from-white via-gray-300 to-gray-500 text-transparent bg-clip-text'>Building digital </span> <br />
           <span className='bg-linear-to-r from-gray-300 via-gray-400 to-gray-500 text-transparent bg-clip-text'>products, brands, and </span> <br />
           <span className='bg-linear-to-r from-gray-500 via-gray-600 to-gray-700 text-transparent bg-clip-text'>experience.</span>
        </motion.h1>
