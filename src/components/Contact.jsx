    ...
    <section className='py-32 px-4 md:px-6 bg-[#0F0F0F]/80'>
        <div className='max-w-6xl mx-auto text-center'>
            ...
            <h2 className='md:text-4xl lg:text-5xl text-3xl mb-12'>
                <span className='bg-linear-to-r from-white via-gray-300 to-gray-500 text-transparent bg-clip-text'>Tell me about your next</span> 
                <br className='md:block hidden'/>
                <span className='bg-linear-to-r from-white via-gray-400 to-gray-500 text-transparent bg-clip-text'> project</span>
            </h2>
            </motion.div>
            ...
            className='flex flex-wrap justify-center gap-4'>
                ...
                <a href="https://wa.me/01946159371" target='_blank' className='inline-flex items-center px-8 py-3 border border-gray-700 text-white rounded-full font-medium hover:border-gray-500 transition-colors'>WhatsApp</a>
            </motion.div>
        </div>
    </section>
  )
