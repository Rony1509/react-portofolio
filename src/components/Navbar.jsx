  ...
  return (
    <header className='border-b border-gray-600'>
        ...
        <div className='flex items-center gap-2'>
            ...
            <span className={`${isMenuOpen ? "hidden": "block"}`}>bsse1509@iit.du.ac.bd</span>
        </div>
        ...
        <nav className={`fixed md:hidden  top-0 right-0 h-screen w-64 bg-black/95 transform transition-transform duration-300 ease-in-out ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'} flex items-center justify-center z-40`}>
            <ul className='flex flex-col space-y-8 text-center'>
                <li>
                    <a onClick={() => setIsMenuOpen(false)} href="#" className='text-gray-300 hover:text-white text-xl'>LinkedIn</a>
                </li>
                <li>
                    <a onClick={() => setIsMenuOpen(false)} href="#" className='text-gray-300 hover:text-white text-xl'>Dribble</a>
                </li>
                <li>
                    <a onClick={() => setIsMenuOpen(false)} href="#" className='text-gray-300 hover:text-white text-xl'>Instagram</a>
                </li>
            </ul>
        </nav>
